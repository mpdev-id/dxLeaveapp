...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-3xl font-bold text-base-content">Edit Workflow</h1>
            <p class="text-base-content/70 mt-1">Modify the existing approval workflow.</p>
        </div>
    ...
    <form action="{{ route('admin.workflows.update', $workflow) }}" method="POST" x-data="workflowForm()" class="space-y-8">
        @csrf
        @method('PUT')
            ...
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-control w-full">
                        ...
                        <input type="text" name="name" class="input input-bordered w-full focus:input-primary" value="{{ $workflow->name }}" required>
                    </div>
                    <div class="form-control w-full">
                        <label class="label">
                            <span class="label-text font-medium">Applicable Model</span>
                        </label>
                        <input type="text" name="applicable_model" class="input input-bordered w-full focus:input-primary font-mono text-sm" value="{{ $workflow->applicable_model }}" required>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                                ...
                                <div class="md:col-span-3 space-y-4">
                                    <div class="form-control w-full">
                                        ...
                                        <select :name="`steps[${index}][required_approvals]`" class="select select-bordered w-full" x-model="step.required_approvals" required>
