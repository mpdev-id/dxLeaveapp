...
@section('content')
    ...
    <form action="{{ route('admin.workflows.store') }}" method="POST" x-data="workflowForm()">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div class="form-control">
                ...
                <input type="text" name="name" class="input input-bordered" placeholder="e.g., Leave Approval" required>
            </div>
            <div class="form-control">
                <label class="label">
                    <span class="label-text">Applicable Model</span>
                </label>
                <input type="text" name="applicable_model" class="input input-bordered" placeholder="e.g., App\Models\LeaveRequest" value="App\Models\LeaveRequest" required>
            </div>
        </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="form-control">
                                ...
                                <select :name="`steps[${index}][required_approvals]`" class="select select-bordered" required>
